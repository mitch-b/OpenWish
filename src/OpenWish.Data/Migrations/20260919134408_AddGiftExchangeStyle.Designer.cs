...
namespace OpenWish.Data.Migrations
{
    ...
    [Migration("20260919134408_AddGiftExchangeStyle")]
    partial class AddGiftExchangeStyle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenWish.Data.Entities.Event", b =>
                {
                    ...
                    b.Property<string>("GiftExchangeStyle")
                        .IsRequired()
                        .HasMaxLength(32)
                    ...
                    b.Property<DateTimeOffset?>("NamesDrawnOn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("OpenWish.Data.Entities.PendingFriendInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OpenWish.Data.Entities.PendingFriendInvite", b =>
                {
                    b.HasOne("OpenWish.Data.Entities.ApplicationUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
